...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(@Lazy JwtFilter jwtFilter, JwtAuthenticationEntryPoint authenticationEntryPoint) {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://frontend:3000", "http://157.66.219.181:3000", "http://157.66.219.181"));
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(
                    "/api/auth/login",
                    "/api/users/register", // Thêm endpoint đăng ký
                    "/api/users/verify",
                    "/swagger-ui/**",
                    "/v3/api-docs/**",
                    "/swagger-ui.html",
